...
/*VERIFY RADIO BUTTONS
    ...
    * */
    ...
    public void test1(){
        ...
        //BrowserUtils.waitFor(3);
        Assert.assertTrue(createCalendarEventsPage.days.isSelected(),"days is checked");

        Assert.assertFalse(createCalendarEventsPage.weekday.isSelected(),"weekday is not checked");
