...
public class iFrameTest {
    ...
    public void test1() throws InterruptedException {
        ...
        public void test2() {
            ...
            //under Default Content html we have top and bottom frame
            ...
            System.out.println(driver.findElement(By.id("content")).getText());// find by id and get the text of web element

            //goes back to parent frame , bc impossible to switch siblings
            driver.switchTo().parentFrame();
